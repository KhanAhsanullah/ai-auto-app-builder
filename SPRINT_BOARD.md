...
| Task 3 | ✅     | EAS build profiles + `expo prebuild` + release checklist              |

RN-first runnable surface over Sprint 19–20 facades and screens.

**Tags:** `sprint21-task1`, `sprint21-task2`, `sprint21-task3`
...
| Task 3 | ✅     | SQLite durable store (`expo-sqlite`) + AsyncStorage migrate/fallback  |

End-result focus: RN host keeps buy-path state after cold start (not just session id).

**Tags:** `sprint22-task1`, `sprint22-task2`, `sprint22-task3`
...
**Tags:** `sprint25-task1`, `sprint25-task2`, `sprint25-task3`

---

## Sprint 26 — Control Plane API
...
**Tags:** `sprint27-task1`, `sprint27-task2`, `sprint27-task3`

---

## Sprint 28 — Platform Catalog Serving
