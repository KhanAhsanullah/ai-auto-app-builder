...
export const LAUNCH_VERTICAL_OPTIONS: ReadonlyArray<{
  ...
  { id: 'grocery', label: 'Grocery', hint: 'Fresh food & essentials' },
  { id: 'restaurant', label: 'Restaurant', hint: 'Menu & takeaway' },
  { id: 'pharmacy', label: 'Pharmacy / Clinic', hint: 'Medicines & care' },
