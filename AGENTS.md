...
**Current state:** Sprints 1–18 complete; Sprint 19 Tasks 1–3 (Surface Wiring) — Task 3 on branch `sprint/19/task3`. Next: merge, then screens or Core Customer.
