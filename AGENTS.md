...
**Current state:** Sprint 28 Task 3 (shareable `/t/:slug` routes) on branch `sprint/28/task3`. Tasks 1–2 on `main`.
...
| 28     | Platform Catalog Serving | In progress (Task 3)     |
