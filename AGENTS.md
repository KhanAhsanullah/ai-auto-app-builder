...
**Current state:** Sprint 21 Task 1 (Expo mobile-host) on branch `sprint/21/task1`. Sprints 1–20 on `main`. Next: RN deep-link/session polish or shippable builds.
...
| 21     | Mobile Host (Expo)  | In progress |
