...
**Current state:** Sprint 27 Task 3 (hosts boot from platform config) on branch `sprint/27/task3`. Tasks 1–2 on `main`.
...
| 27     | Platform Config Serving | In progress (Task 3)     |
