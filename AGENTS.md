...
**Current state:** Sprint 25 Task 3 (wizard visual polish) on branch `sprint/25/task3`. Tasks 1–2 on `main`.
...
| 25     | Storefront UI Polish | In progress              |
