...
**Current state:** Sprints 1–16 complete; Sprint 17 Task 1 (Core Order domain) on branch `sprint/17/task1`. Next: Sprint 17 Task 2 — order helpers.
