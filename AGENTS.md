...
**Current state:** Sprints 1–15 complete; Sprint 16 Tasks 1–3 (Core Checkout) implemented on branch. Next: merge to main, then Core Order / payment handoff.
