...
**Current state:** Sprint 26 Task 1 (platform-api Boom HTTP) on branch `sprint/26/task1`. Sprint 25 on `main`.
...
| 26     | Control Plane API    | In progress              |
