...
**Current state:** Sprints 1–18 complete; Sprint 19 Tasks 1–2 (Surface Wiring) — Task 2 on branch `sprint/19/task2`. Next: Task 3 order/payment binding.
