...
**Current state:** Sprints 1–5 complete; Sprint 6 Task 1 (auth policy foundation) implemented. Next: Sprint 6 Task 2 — auth provider adapters.
...
**Latest commit:** `860d8df`
**Latest tag:** `sprint5-task3`
