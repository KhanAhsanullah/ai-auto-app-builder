...
**Current state:** Sprint 24 Task 1 (Boom launch wizard) on branch `sprint/24/task1`. Sprint 23 Tasks 1–2 on `main`.
...
| 23     | Web Store Host      | In progress (Tasks 1–2 ✅) |
| 24     | Launch Wizard       | In progress                |
